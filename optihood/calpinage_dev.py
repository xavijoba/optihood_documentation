                ...
                if teta % 90 ==0:
                    ...
                    if self.rows.loc[self.rows.index.size-1,'N_panel']>0:
                        ...
                        for z in range(0,int(self.rows.loc[self.rows.index.size-1,'N_panel'])):
                            ...
                            b8=affinity.translate(b7,xoff=z*(self.l+self.off_pnl)*np.sin(np.radians(teta)),
                                              yoff=-z*(self.l+self.off_pnl)*np.cos(np.radians(teta)))
                    ...
                    b2 = affinity.rotate(b1, -90+teta, (b1.bounds[0], b1.bounds[1]))
                    ...
                    L1=affinity.rotate(L1,90+teta,(B1.bounds[2],B1.bounds[1]))
                    L1=affinity.translate(L1,yoff=b3.bounds[1]+self.l*math.cos(math.radians(teta))
                                            -B1.bounds[1],xoff=0)
                    ...
                    while (L_west.intersection(B1).length and L_east.intersection(B1).length)>0 :
                        ...
                        b4 = affinity.rotate(b4a,teta, (L_west.intersection(B1).bounds[0],
                        ...
                        b5 = affinity.rotate(b5b, teta, (L_east.intersection(B1).bounds[2],
                    ...
                    L1=LineString([(B1.bounds[0], B1.bounds[1]), (B1.bounds[2], B1.bounds[1])]) 
                    L1=affinity.rotate(L1,-90+teta,(B1.bounds[0],B1.bounds[1]))
                    ...
                    while (L_west.intersection(B1).length and L_east.intersection(B1).length)>0 :
                        ...
                        b4 = affinity.rotate(b4a,teta, (L_west.intersection(B1).bounds[2],
                                                            L_west.intersection(B1).bounds[1]),
                                                                                use_radians=False)
                ...
                if teta % 90 ==0:
                    ...
                    if self.rows.loc[self.rows.index.size-1,'N_panel']>0:
                        ...
                        for z in range(1,int(self.rows.loc[self.rows.index.size-1,'N_panel'])):
                            ...
                            b8=affinity.translate(b7,xoff=z*(self.l+self.off_pnl)*math.cos(math.radians(teta)),
                                              yoff=z*(self.l+self.off_pnl)*math.sin(math.radians(teta)))
                    ...
                    while L_north.intersection(B1).length>0:
                        ...
                        if teta==-90:
                            L_south=L_south.parallel_offset(off_row+self.w*math.cos(math.radians(self.tilt)),side='left')
                            L_north=L_north.parallel_offset(off_row+self.w*math.cos(math.radians(self.tilt)),side='left')
                        elif teta == 90:
                            L_south=L_south.parallel_offset(off_row+self.w*math.cos(math.radians(self.tilt)))
                            L_north=L_north.parallel_offset(off_row+self.w*math.cos(math.radians(self.tilt)))
                        elif teta == 0:
                            L_south=L_south.parallel_offset(off_row+self.w*math.cos(math.radians(self.tilt)))
                            L_north=L_north.parallel_offset(off_row+self.w*math.cos(math.radians(self.tilt)))
                    ...
                    b2 = affinity.rotate(b1, teta, (b1.bounds[2], b1.bounds[3]))
                    b3=affinity.translate(b2,xoff=0,
                    ...
                    L1=LineString([(B1.bounds[0], B1.bounds[1]), (B1.bounds[2], B1.bounds[1])]) 
                    L1=affinity.rotate(L1,teta,(B1.bounds[2],B1.bounds[1]))
                    ...
                    search_bound=L_north.parallel_offset(off_row+self.w*math.cos(math.radians(self.tilt)))
                    ...
                    while search_bound.intersection(B1).length>0:
                        ...
                        if L_north.intersection(B1).length>self.l :
                            ...
                            b4 = affinity.rotate(b4a,teta+90, (L_north.intersection(B1).bounds[0],
                            ...
                            b5 = affinity.rotate(b5b, teta+90, (L_south.intersection(B1).bounds[0],
                    ...
                    b2 = affinity.rotate(b1, teta, (b1.bounds[0], b1.bounds[3]))
                    b3=affinity.translate(b2,xoff=0,
                                          yoff=self.W-self.d_W-b2.bounds[3])
                    b3_xy=pd.DataFrame(b3.boundary.xy).sort_values(by=0,axis=1)
                    con_area=b3.area*self.off_pnl/self.l
                    L1=LineString([(B1.bounds[0], B1.bounds[1]), (B1.bounds[2], B1.bounds[1])]) 
                    L1=affinity.rotate(L1,+teta,(B1.bounds[0], B1.bounds[1]))          
                    ...
                    while L_north.intersection(B1).length>0:
                        ...
                        if L_north.intersection(B1).length>0 :
                            ...
                            b4 = affinity.rotate(b4a, teta, (L_north.intersection(B1).bounds[0],
                            ...
                            b5 = affinity.rotate(b5b, teta, (L_south.intersection(B1).bounds[0],
                            ...
                            if self.rows.loc[self.rows.index.size-1,'N_panel']>0:
                                ...
                                if self.f_plot==True:
                                    ax.plot(*b7.exterior.xy)
                                for z in range(1,int(self.rows.loc[self.rows.index.size-1,'N_panel'])):
                                    b8=affinity.translate(b7,xoff=np.abs(z*(self.l+self.off_pnl)*math.cos(math.radians(teta))),
                                                      yoff=np.abs(z*(self.l+self.off_pnl)*math.sin(math.radians(teta))))
                                    if self.f_plot==True:
                                        ax.plot(*b8.exterior.xy)
                    if self.f_plot==True:
                        plt.show()
